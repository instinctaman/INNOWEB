...
var tarteaucitron = {
    ...
    "userInterface": {
        ...
        "respondAll": function (status) {
            ...
            if (status === true) {
                ...
                dataLayer.push({ event: 'rgpd', action: 'accepter' });
            } else if (status === false) {
                dataLayer.push({ event: 'rgpd', action: 'refuser' });
            }
        },
        "respondNone": function () {
            "use strict";
            var s = tarteaucitron.services,
                service,
                key,
            ...
            for (index = 0; index < tarteaucitron.job.length; index += 1) {
                service = s[tarteaucitron.job[index]];
                key = service.key;
                var status = tarteaucitron.state[key] ? true : false;
                if (tarteaucitron.state[key] !== status) {
                    if (status === false && tarteaucitron.launch[key] === true) {
                        tarteaucitron.reloadThePage = true;
                    }
        ...
        "openPanel": function () {
            ...
            tarteaucitron.userInterface.jsSizing('main');
            if (document.querySelector('#tarteaucitronAlertBig').style.display != 'none') {
            ...
            if (document.cookie !== '') {
                for (i = 0; i < nb; i += 1) {
                    ...
                    if (tarteaucitron.cookie.owner[name] !== undefined && tarteaucitron.cookie.owner[name].join(' // ') !== savedname) {
                        ...
                        html += '     <span class="tarteaucitronTitle tarteaucitronH3" role="heading" >';
    ...
    "getLanguage": function () {
        ...
        var lang = "fr";
        if (document.querySelector("html").getAttribute("lang") && document.querySelector("html").getAttribute("lang") != "") {
            lang = document.querySelector('html').getAttribute('lang')
        } else if (document.location.href.toLowerCase().indexOf(document.location.hostname + "/en") > -1) {
            lang = "en";
        }

        var userLanguage = lang.substr(0, 2);
